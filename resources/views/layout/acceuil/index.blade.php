...
<div class="wrapper col2">
  <div id="header" class="clear">
    ...
    <div id="topnav">
      <ul>
        <li class="last"><a href="pages/gallery.html">Gallery</a><span>Test Text Here</span></li>
  ...
  <div id="container" class="clear"> 
    ...
    <div id="homepage" class="clear">
      <div class="fl_left">
        ...
        <div id="hpage_slider">
          <div class="item"><img src="{{asset('assets/images/demo/featured-project/1.gif')}}" alt="" /></div>
          <div class="item"><img src="{{asset('assets/images/demo/featured-project/2.gif')}}" alt="" /></div>
          <div class="item"><img src="{{asset('assets/images/demo/featured-project/3.gif')}}" alt="" /></div>
          <div class="item"><img src="{{asset('assets/images/demo/featured-project/4.gif')}}" alt="" /></div>
          <div class="item"><img src="{{asset('assets/images/demo/featured-project/5.gif')}}" alt="" /></div>
        </div>
